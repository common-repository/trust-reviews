...
<div class="trp-flex-row">
    <div class="trp-flex-col3">
        <b>1</b> Search for your business on Google.
    </div>
    <div class="trp-flex-col7">
        <div class="box-img"><img src="<?php echo TRP_PLUGIN_URL . '/assets/img/google_placeid_1.png'; ?>"></div>
    </div>
</div>
...
<div class="trp-flex-row">
    ...
    <div class="trp-flex-col7">
        <div class="box-img"><img src="<?php echo TRP_PLUGIN_URL . '/assets/img/google_placeid_2.png'; ?>"></div>
    </div>
</div>
...
<div class="trp-flex-row">
    ...
    <div class="trp-flex-col7">
        <div class="box-img"><img src="<?php echo TRP_PLUGIN_URL . '/assets/img/google_placeid_3.png'; ?>"></div>
    </div>
</div>
...
<div class="trp-flex-row">
    ...
    <div class="trp-flex-col">
        <div class="box-img"><img src="<?php echo TRP_PLUGIN_URL . '/assets/img/google_key_1.png'; ?>"></div>
    </div>
</div>
...
<div class="trp-flex-row">
    ...
    <div class="trp-flex-col">
        <div class="box-img"><img src="<?php echo TRP_PLUGIN_URL . '/assets/img/google_key_2.png'; ?>"></div>
        <div class="box-img"><img src="<?php echo TRP_PLUGIN_URL . '/assets/img/google_key_2_1.png'; ?>"></div>
    </div>
</div>
...
<div class="trp-flex-row">
    ...
    <div class="trp-flex-col">
        <div class="box-img"><img src="<?php echo TRP_PLUGIN_URL . '/assets/img/google_key_3.png'; ?>"></div>
    </div>
</div>
...
<div class="trp-flex-row">
    ...
    <div class="trp-flex-col">
        <div class="box-img"><img src="<?php echo TRP_PLUGIN_URL . '/assets/img/google_key_4.png'; ?>"></div>
        <div class="box-img"><img src="<?php echo TRP_PLUGIN_URL . '/assets/img/google_key_4_1.png'; ?>"></div>
    </div>
</div>
...
<div class="trp-flex-row">
    ...
    <div class="trp-flex-col">
        <div class="box-img"><img src="<?php echo TRP_PLUGIN_URL . '/assets/img/google_key_5.png'; ?>"></div>
    </div>
</div>
...
<div class="trp-flex-row">
    ...
    <div class="trp-flex-col">
        <div class="box-img"><img src="<?php echo TRP_PLUGIN_URL . '/assets/img/google_key_6.png'; ?>"></div>
    </div>
</div>
...
<div class="trp-flex-row">
    ...
    <div class="trp-flex-col">
        <div class="box-img"><img src="<?php echo TRP_PLUGIN_URL . '/assets/img/google_key_7.png'; ?>"></div>
    </div>
</div>
...
<div class="trp-flex-row">
    ...
    <div class="trp-flex-col">
        <div class="box-img"><img src="<?php echo TRP_PLUGIN_URL . '/assets/img/google_key_8.png'; ?>"></div>
    </div>
</div>
